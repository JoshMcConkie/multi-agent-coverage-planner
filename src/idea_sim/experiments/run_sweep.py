...
score_norm = centered_ratio_norm([
    df["split_ratio_to_seq_min"],
    df["split_ratio_to_seq_mean"],
])

runtime_norm = centered_ratio_norm([
...
for n in range(1, num_agents + 1):
    plot_ratio_heatmap(
        ...
        colorbar_label="min score ratio (split / greedy)",
        filename=(
    ...
    plot_ratio_heatmap(
        ...
        colorbar_label="mean score ratio (split / greedy)",
        filename=(
    ...
    plot_ratio_heatmap(
        ...
        colorbar_label="max runtime ratio (split / greedy)",
        filename=(
    ...
    plot_ratio_heatmap(
        ...
        colorbar_label="mean runtime ratio (split / greedy)",
        filename=(

...
$$
\text{Coverage}(S) = \sum_{c \in \mathcal{C}} \max_{p \in S}\{\omega_{cp}\}.
$$
...
$$
e_k \in \arg\max_{e \in \mathcal{P}_k} \Big\{ \text{Coverage}\big(S_{k-1} \cup \{e\}\big) - \text{Coverage}(S_{k-1}) \Big\},
$$
...
$$
\max_{e \in \mathcal{P}} \text{Coverage}\bigg[\bigcup_{k=1}^{K} \{e_k\}\bigg].
$$
